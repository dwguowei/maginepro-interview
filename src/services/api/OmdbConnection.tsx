...
export type SearchResponse = {Response: "True", Search: Search[]};
export type ErrorResponse = {Response: "False", Error: string};
export type GetResponse = {
  ...
  totalSeasons?: string, Season?: string, Episode?: string, Error?: string
};
